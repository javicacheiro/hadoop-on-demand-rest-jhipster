...
import es.cesga.hadoop.web.filter.CachingHttpHeadersFilter;
import es.cesga.hadoop.web.filter.StaticResourcesProductionFilter;
import es.cesga.hadoop.web.filter.gzip.GZipServletFilter;
