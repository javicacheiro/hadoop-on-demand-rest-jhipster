...
import es.cesga.hadoop.domain.Authority;
import es.cesga.hadoop.domain.User;
import es.cesga.hadoop.repository.AuthorityRepository;
import es.cesga.hadoop.repository.UserRepository;
import es.cesga.hadoop.security.AuthoritiesConstants;
import es.cesga.hadoop.service.MailService;
import es.cesga.hadoop.service.UserService;
import es.cesga.hadoop.web.rest.dto.UserDTO;
